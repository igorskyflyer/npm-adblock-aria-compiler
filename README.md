...
You should read the official [ADBT API](https://github.com/igorskyflyer/vscode-adbt) documentation for more information on how ADBT works, its syntax and usage.
