...
You should read the official [ADBT API](https://github.com/igorskyflyer/file-formats/blob/main/adbt/README.md) documentation for more information on how ADBT works, its syntax and usage.
